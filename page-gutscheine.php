...
<style>
    ...
    .voucher-img-wrap{position:relative;z-index:1;width:100%;max-width:480px;filter:drop-shadow(0 20px 40px rgba(74,59,50,0.1));transition:transform 0.6s cubic-bezier(0.34, 1.56, 0.64, 1)}
    .voucher-img-wrap:hover{transform:translateY(-12px) scale(1.02)}
    .voucher-img-wrap img{width:100%;height:auto;display:block;mix-blend-mode:multiply;filter:saturate(0.9) contrast(0.95);opacity:0.95}

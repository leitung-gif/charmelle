...
function charmelle_get_page_seo() {
    ...
    if ( is_page( 'behandlungen' ) ) {
        ...
        $seo = array(
            ...
            'description' => 'Impressum der Charmelle Beauty Center GmbH, Girixweg 7, 5000 Aarau. Handelsregister-Nr. CH-400.4.024.451-7, Kanton Aargau. Geschäftsführung: Aurora Liloia & Oriana Raso.',
